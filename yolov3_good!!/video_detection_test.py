# USAGE
# python video_detection_test.py -y yolo-coco
...
while True:
    #img = cv2.VideoCapture('newdisplay.mp4')
    ...
    # if PI_Camera f filmed, the size is (900, 1600).
        ...
        image = [img[0:512, 1024:1440], img[960:1440, 1024:1440], img[512:960, 0:1024], img[512:960, 1440:2560]]
    ...
    # show the output image
    cv2.namedWindow(" top", cv2.WINDOW_NORMAL) # You can resize the window
    cv2.namedWindow(" bottom", cv2.WINDOW_NORMAL) # You can resize the window
    cv2.namedWindow(" right", cv2.WINDOW_NORMAL) # You can resize the window
    cv2.namedWindow(" left", cv2.WINDOW_NORMAL) # You can resize the window
    
    cv2.imshow(" top", image[0])
    cv2.imshow(" bottom", image[1])
    cv2.imshow(" right", image[2])
    cv2.imshow(" left", image[3])
